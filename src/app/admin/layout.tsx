...
import { LayoutDashboard,Users,Clock,Calendar,FileText,TrendingUp,Bell,LogOut,ChevronRight,Menu } from 'lucide-react'

const NAV = [{href:'/admin',label:'Dashboard',icon:LayoutDashboard},{href:'/admin/empleados',label:'Empleados',icon:Users},{href:'/admin/horarios',label:'Horarios',icon:Clock},{href:'/admin/vacaciones',label:'Vacaciones',icon:Calendar},{href:'/admin/bajas',label:'Bajas',icon:FileText},{href:'/admin/informes',label:'Informes',icon:TrendingUp},{href:'/admin/avisos',label:'Avisos',icon:Bell}]
