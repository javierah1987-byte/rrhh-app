...
import { LayoutDashboard,Clock,Calendar,FileText,User,LogOut,ChevronRight,Menu } from 'lucide-react'

const NAV = [{href:'/empleado',label:'Inicio',icon:LayoutDashboard},{href:'/empleado/fichaje',label:'Fichaje',icon:Clock},{href:'/empleado/solicitudes',label:'Solicitudes',icon:Calendar},{href:'/empleado/bajas',label:'Mis bajas',icon:FileText},{href:'/empleado/perfil',label:'Mi perfil',icon:User}]
