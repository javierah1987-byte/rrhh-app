...
export default function LoginPage(){
  ...
  async function handleLogin(e:React.FormEvent){
    ...
    if(authError||!data.user){setError('Email o contraseña incorrectos');setLoading(false);return}
