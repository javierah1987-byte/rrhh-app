...
const DEMO_USERS = [
  ...
  { email: 'luis@acme.com', pass: '1234', rol: 'Empleado (baja)' },
]
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-blue-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900">ACME RRHH</h1>
          <p className="text-gray-500 text-sm mt-1">Sistema de gestión de recursos humanos</p>
        </div>
        ...
        <div className="mt-6 card p-4">
          <p className="text-xs font-medium text-gray-500 mb-3">Usuarios de prueba</p>
          <div className="space-y-1.5">
            {DEMO_USERS.map((u) => (
              ...
              >
                ...
                <span className="text-xs text-gray-400 ml-2">/ {u.pass}</span>
                <span className="float-right text-xs text-indigo-600">{u.rol}</span>
              </button>
            ))}
          </div>
        </div>
