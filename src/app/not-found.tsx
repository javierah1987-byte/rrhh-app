    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-900 p-8">
      <div className="text-center max-w-md animate-fade-in">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Link href="/login" className="inline-flex items-center justify-center gap-2 px-6 py-2.5 bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 font-medium rounded-xl border border-slate-200 dark:border-slate-700 transition-colors">
            Iniciar sesión
          </Link>
        </div>
      </div>
